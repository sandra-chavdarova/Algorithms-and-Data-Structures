...
(if there are more with the same highest amount then which one is the first one in the input?)
(there will always be at least one such)
...
public class EnoughBudgetByIP {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            Person person = new Person(name, surname, budget, IPaddress, time, city, price, network);
